...
public class SUBTest {
    ...
    public void testSUB_0()
        ...
        inputMap.put(String.format(SUB.INPUT_IN, 1), in1);

        Connector<Integer> out = new INT(0, 0);

        outputMap.put(String.format(SUB.OUTPUT_OUT), out);

        SUB block = new SUB(0, 0, inputMap, outputMap);

        block.execute();

        assertThat("block does not update output connector.",
                block.getOutput(SUB.OUTPUT_OUT), equalTo(out));

        assertThat("block does not perform operation correctly.",
                block.getOutputValue(SUB.OUTPUT_OUT), equalTo(0));
    }
    ...
    public void testSUB_1()
        ...
        assertThat("block does not perform operation correctly.",
                block.getOutputValue(SUB.OUTPUT_OUT), equalTo(1));
    }
    ...
    public void testSUB_2()
        ...
        inputMap.put(String.format(SUB.INPUT_IN, 1), in1);
        inputMap.put(String.format(SUB.INPUT_IN, 2), in2);

        Connector out = new INT(0, 0);

        outputMap.put(SUB.OUTPUT_OUT, out);
    ...
    public void testSUB_3()
        ...
        assertThat("block does not perform operation correctly.",
                block.getOutputValue(SUB.OUTPUT_OUT), equalTo(-3));
    }
