...
public class GETest {
    ...
    public void testGE_0()
        ...
        assertThat("block does not update output connector.",
                block.getOutputs().get(GE.OUTPUT_OUT), equalTo(out));

        assertThat("block does not perform operation correctly.",
                block.getOutputs().get(GE.OUTPUT_OUT).getValue(), equalTo(true));
    }
    ...
    public void testGE_4()
        ...
        assertThat("block does not perform operation correctly.",
                block.getOutputs().get(GE.OUTPUT_OUT).getValue(), equalTo(false));
    }
