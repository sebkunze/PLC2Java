...
public class GTTest {
    ...
    public void testGT_0()
        ...
        GT block = new GT(0, ins, out);

        block.execute();

        assertThat("block does not update output connector.",
                block.getOutputs().get(GT.OUTPUT_OUT), equalTo(out));

        assertThat("block does not perform operation correctly.",
                block.getOutputs().get(GT.OUTPUT_OUT).getValue(), equalTo(true));
    }
    ...
    public void testGT_2()
        ...
        assertThat("block does not perform operation correctly.",
                block.getOutputs().get(GT.OUTPUT_OUT).getValue(), equalTo(false));
    }
