...
public class LTTest {
    ...
    public void testLT_0()
        ...
        outputMap.put(LT.OUTPUT_OUT, out);

        LT block = new LT(0, 0, inputMap, outputMap);

        block.execute();

        assertThat("block does not update output connector.",
                 block.getOutput(LT.OUTPUT_OUT), equalTo(out));

        assertThat("block does not perform operation correctly.",
                 block.getOutputValue(LT.OUTPUT_OUT), equalTo(true));
    }
    ...
    public void testLT_2()
        ...
        assertThat("block does not perform operation correctly.",
                 block.getOutputValue(LT.OUTPUT_OUT), equalTo(false));
    }
